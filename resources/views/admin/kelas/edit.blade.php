<x-app-layout>
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-lg mx-auto mt-10">
            ...
            <h1 class="text-xl font-bold mb-4 text-black text-center">Edit Kelas</h1>
            ...
            <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST" >
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_kelas" value="{{ $kelas->nama_kelas }}" class="w-full border rounded p-2" required>
                </div>
                ...
                <div class="flex justify-between gap-4 text-center">
                    ...
                    <button type="submit" class="w-full px-4 py-2 bg-yellow-600 text-white rounded">Update</button>
                </div>
            </form>
    ...
    <div @click.away="isOpenTambah = false" class="bg-white rounded-lg shadow-xl w-full max-w-sm p-6 transform transition-all duration-300">
        <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST">
            ...
            <div class="flex justify-end items-start pb-3 ">
                <button type="button" @click="isOpenEdit = false" class="text-gray-400 hover:text-gray-600">
            ...
            <div class="flex justify-center gap-4 w-full">
                <button type="button" @click="isOpenEdit = false" class="w-full px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">Batal</button>
